...
class Config:
    ...
    LSTM_CONFIG = {
        ...
        'sliding': [12],
        'batch_size': [64, 128],
        'num_units': [[8], [16], [32], [8, 4], [16, 8], [32, 16], [16, 8, 4], [32, 16, 8], [64, 32, 16], [32, 16, 8, 4], [64, 32, 16, 8], [128, 64, 32, 16]],
        'dropout_rate': [0.9],
    ...
    AUTOENCODER_PRETRAIN_CONFIG = {
        ...
        'sliding_encoder': [12],
        'batch_size': [64, 128],
        'num_units_lstm': [[8, 4], [16, 8], [32, 16], [16, 8, 4], [32, 16, 8], [64, 32, 16], [32, 16, 8, 4], [64, 32, 16, 8], [128, 64, 32, 16]],
